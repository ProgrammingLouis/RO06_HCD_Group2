...
#ifndef WIDTH
#define WIDTH 256 // Taille par d�faut si non d�finie
#endif

#ifndef HEIGHT
#define HEIGHT 256 // Taille par d�faut si non d�finie
#endif
...
#pragma HLS INLINE
 ...
 // Lecture de I_y (d�calage de SIZE pour la seconde image)
 for (int y = 0; y < IMG_HEIGHT; y++) {
