...
architecture rtl of HLS_accel_I_x_ram is 
...
architecture arch of HLS_accel_I_x is
    component HLS_accel_I_x_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    HLS_accel_I_x_ram_U :  component HLS_accel_I_x_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
