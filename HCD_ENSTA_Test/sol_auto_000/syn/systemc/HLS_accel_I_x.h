...
// ==============================================================
#ifndef __HLS_accel_I_x_H__
#define __HLS_accel_I_x_H__
...
struct HLS_accel_I_x_ram : public sc_core::sc_module {
...
HLS_accel_I_x_ram* meminst;


SC_CTOR(HLS_accel_I_x) {
meminst = new HLS_accel_I_x_ram("HLS_accel_I_x_ram");
