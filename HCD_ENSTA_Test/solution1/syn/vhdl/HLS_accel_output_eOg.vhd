...
entity HLS_accel_output_eOg_ram is 
    generic(
...
architecture rtl of HLS_accel_output_eOg_ram is 
...
entity HLS_accel_output_eOg is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of HLS_accel_output_eOg is
    component HLS_accel_output_eOg_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    HLS_accel_output_eOg_ram_U :  component HLS_accel_output_eOg_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
