...
// ==============================================================
#ifndef __HLS_accel_sitodp_ibs__HH__
#define __HLS_accel_sitodp_ibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(HLS_accel_sitodp_ibs) {
    ...
    SC_CTOR(HLS_accel_sitodp_ibs):  ACMP_sitodp_U ("ACMP_sitodp_U") {
