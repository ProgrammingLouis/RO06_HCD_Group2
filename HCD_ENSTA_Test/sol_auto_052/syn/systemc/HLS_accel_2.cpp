...
void HLS_accel::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        grp_apply_kernel_single_s_fu_10038_ap_start_reg = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state759.read())) {
            grp_apply_kernel_single_s_fu_10038_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_apply_kernel_single_s_fu_10038_ap_ready.read())) {
            grp_apply_kernel_single_s_fu_10038_ap_start_reg = ap_const_logic_0;
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        grp_apply_kernel_single_s_fu_9913_ap_start_reg = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state604.read()) || 
            ...
            grp_apply_kernel_single_s_fu_9913_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_apply_kernel_single_s_fu_9913_ap_ready.read())) {
            grp_apply_kernel_single_s_fu_9913_ap_start_reg = ap_const_logic_0;
        }
    }
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        grp_apply_kernel_single_s_fu_9935_ap_start_reg = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state604.read()) || 
             esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state527.read()) || 
             esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state682.read()) || 
             esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state759.read()))) {
            grp_apply_kernel_single_s_fu_9935_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_apply_kernel_single_s_fu_9935_ap_ready.read())) {
            grp_apply_kernel_single_s_fu_9935_ap_start_reg = ap_const_logic_0;
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp2_stage0.read()) && 
